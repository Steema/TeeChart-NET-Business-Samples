...
namespace StandardSeriesWPFDemo
{
  ...
  public partial class StartForm : UserControl
  {
    ...
    List<Steema.TeeChart.WPF.TChart> Charts;

    private void InitializeChart()
    {
      Charts = new List<Steema.TeeChart.WPF.TChart>();
      Charts.Add(tChart1);
      Charts.Add(tChart2);
      Charts.Add(tChart3);
      Charts.Add(tChart4);
      ...
      foreach (var item in Charts)
      {
        ...
        item.Header.Alignment = StringAlignment.Near;
      ...
      bar.Gradient.EndColor = Color.Transparent;
      ...
      bar.Marks.ShapeStyle = Steema.TeeChart.Drawing.TextShapeStyle.RoundRectangle;
      ...
      bubble.Pointer.Gradient.EndColor = Color.Transparent;
      tChart5.Axes.Left.Labels.Font.Color = Color.Transparent;
      bubble.Add(1, 1, 1);
      bubble.Add(2, 2, 10);
      bubble.Add(3, 3, 5);
      bubble.Add(4, 4, 3);
      ...
      area.Gradient.EndColor = Color.Transparent;
      area.Smoothed = true;
      ...
      area1.Gradient.EndColor = Color.Transparent;
      area1.Smoothed = true;
      ...
      Steema.TeeChart.Styles.Calendar calendar = new Steema.TeeChart.Styles.Calendar(tChart7.Chart);
    ...
    private void Pie_BeforeDrawValues(object sender, Steema.TeeChart.Drawing.IGraphics3D g)
    {

      var width = g.ChartXCenter * 2;
      var height = g.ChartYCenter * 2;

      var rect = Utils.FromLTRB(buffer, buffer, width - buffer, (height / 2) - (buffer / 2));

      tChart3.Chart.ChartRect = rect;

    }

    private void Donut_BeforeDrawValues(object sender, Steema.TeeChart.Drawing.IGraphics3D g)
    {
      var donutBuffer = 20;
      var width = g.ChartXCenter * 2;
      var height = g.ChartYCenter * 2;

      var rect = Utils.FromLTRB(buffer + donutBuffer, (height / 2) - (buffer / 2), width - buffer - donutBuffer, height - buffer);
